...
# This synthetic preset illustrates an independent-parameter experiment.
# It does not establish spectral or k-mesh convergence.
const DEMONSTRATION_K_MESH = (100, 100)

"""Build two independently parameterized Shift Current tasks on one sampling grid."""
    ...
    return TaskConfig(
        ...
        output = OutputOptions(
            output_root = ExampleSupport.example_output_root(
                "bundle_shift_current_broadenings",
                output_root,
            ),
