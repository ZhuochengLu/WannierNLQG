...
@testset "native QE MMN/AMN 1/2/4-thread fresh-process determinism" begin
    probe = joinpath(@__DIR__, "QEPAWMatrixElementsThreadProbe.jl")
    ...
    for threads in (1, 2, 4)
        ...
        matched = match(r"QE_PAW_MATRIX_DIGEST=([0-9a-f]{64})", output)
